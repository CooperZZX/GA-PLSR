...
% size是在坐标区绘图区域的满载程度，1代表100%，0.9代表90%。第一和元素是宽度，第二个元素是高度
% author : ZZX
% time   : 2022-07-29

function [] = RemoveSubplotWhiteArea(gca, sub_row, sub_col, current_row, current_col, size)
% 设置OuterPosition
sub_axes_x = current_col*1/sub_col - 1/sub_col;
sub_axes_y = 1-current_row*1/sub_row; % y是从上往下的
sub_axes_w = 1/sub_col*size(1);
sub_axes_h = 1/sub_row*size(2);
